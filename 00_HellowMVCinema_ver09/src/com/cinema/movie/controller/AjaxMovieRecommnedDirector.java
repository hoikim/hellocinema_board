...
/**
 * Servlet implementation class AjaxMovieRecommnedDirector
 */
@WebServlet({ "/AjaxMovieRecommnedDirector", "/movie/director" })
public class AjaxMovieRecommnedDirector extends HttpServlet {
     ...
     */
    public AjaxMovieRecommnedDirector() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		list = new MovieService().recommendMovieDirector(director);
