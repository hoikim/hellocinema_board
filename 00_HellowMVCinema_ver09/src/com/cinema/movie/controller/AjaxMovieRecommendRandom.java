...
/**
 * Servlet implementation class AjaxMovieRecommendRandom
 */
@WebServlet({ "/AjaxMovieRecommendRandom", "/movie/random" })
public class AjaxMovieRecommendRandom extends HttpServlet {
     ...
     */
    public AjaxMovieRecommendRandom() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		list = new MovieService().recommendMovieRandom();
