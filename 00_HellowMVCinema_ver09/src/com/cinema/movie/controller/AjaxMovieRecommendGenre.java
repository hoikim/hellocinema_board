...
/**
 * Servlet implementation class AjaxMovieRecommendGenre
 */
@WebServlet({ "/AjaxMovieRecommendGenre", "/movie/recommendGenre" })
public class AjaxMovieRecommendGenre extends HttpServlet {
     ...
     */
    public AjaxMovieRecommendGenre() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		list = new MovieService().recommendMovieGenre(genre); // object
		//int temp[] = new int[10];
